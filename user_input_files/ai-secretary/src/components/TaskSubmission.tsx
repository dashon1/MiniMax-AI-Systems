    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            <label className="text-sm font-medium text-slate-700">Manual Agent Selection</label>
        ...
        <AnimatePresence>
          {routing && (
            ...
            >
              <h4 className="font-medium text-slate-800 mb-3">Agent Selection Preview</h4>
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-slate-600 mt-1">{selectedAgentData?.description}</p>
                  </div>
                </div>
                
                <div className="text-sm">
                  <span className="font-medium text-slate-700">Selection Reasoning: </span>
                  <span className="text-slate-600">{routing.reasoning}</span>
                </div>
                
                {routing.alternatives && routing.alternatives.length > 0 && (
                  <div>
                    <span className="text-sm font-medium text-slate-700">Alternative Agents:</span>
